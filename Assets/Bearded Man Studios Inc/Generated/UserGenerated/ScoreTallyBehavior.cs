...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class ScoreTallyBehavior : NetworkBehavior
	{
		...
		public ScoreTallyNetworkObject networkObject = null;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (ScoreTallyNetworkObject)obj;
		...
		{
			Initialize(new ScoreTallyNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new ScoreTallyNetworkObject(networker, this, createCode, metadata);
		}
